...
<div class="page-sidebar" id="sidebar">
	...
	<div class="sidebar-header-wrapper">
		...
		<div class="searchhelper">Busca rápida, Relatórios, E-mails ou
			Notificaçães</div>
	</div>
	<!-- /Page Sidebar Header -->
	<!-- Sidebar Menu -->
	<ul class="nav sidebar-menu">
		...
		<li><a href="#" class="menu-dropdown"> <i
			...
			<ul class="submenu">
				...
				<li><a href="nestable-list.html"> <span class="menu-text">
							Nestable List</span>
				</a></li>
		...
		<li><a href="#" class="menu-dropdown"> <i
			...
			<ul class="submenu">
				<li><a href="tables-simple.html"> <span class="menu-text">Simple
							& Responsive</span>
				</a></li>
		...
		<li><a href="#" class="menu-dropdown"> <i
				class="menu-icon fa fa-pencil-square-o"></i> <span class="menu-text">
					Forms </span> <i class="menu-expand"></i>
		</a>
		...
		<li><a href="#" class="menu-dropdown"> <i
			...
			<ul class="submenu">
				...
				<li><a href="#" class="menu-dropdown"> <span
						class="menu-text"> Multi Level Menu </span> <i class="menu-expand"></i>
				</a>
		...
		<li><a href="versions.html"> <i
				...
				class="menu-text"> Oh! Softwares </span>
		</a></li>-->
	</ul>
	<!-- /Sidebar Menu -->
</div>
